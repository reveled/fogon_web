...
export const getCurrentActiveState = (parentId) => {
	...
	if (parentElement.name !== 'droip-login') return getCurrentActiveState(parentElement.parentId);
...
const LoginElement = (props) => {
	...
	const templates = () => [['droip-login-error', { manualDelete: false, properties: {} }]];
