...
export const getCurrentActiveState = (parentId) => {
	...
	if (parentElement.name !== 'droip-change-password') return getCurrentActiveState(parentElement.parentId);
...
const ChangePasswordElement = (props) => {
	...
	const templates = () => [['droip-change-password-error', { manualDelete: false, properties: {} }]];
