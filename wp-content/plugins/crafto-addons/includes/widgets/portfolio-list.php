...
/**
 * Crafto widget for portfolio.
 *
 * @package Crafto
 */

// If class `Portfolio_List` doesn't exists yet.
if ( ! class_exists( 'CraftoAddons\Widgets\Portfolio_List' ) ) {
	/**
	 * Define `Portfolio_List` class.
	 */
	class Portfolio_List extends Widget_Base {
		/**
		 * Retrieve the list of scripts the portfolio widget depended on.
		 *
		...
		public function get_script_depends() {
			$portfolio_list_scripts = [];

			if ( \Crafto_Addons_Extra_Functions::crafto_editor_load_compressed_assets() ) {
				$portfolio_list_scripts[] = 'crafto-widgets';
			} else {
				if ( crafto_disable_module_by_key( 'magnific-popup' ) ) {
					$portfolio_list_scripts[] = 'magnific-popup';
					$portfolio_list_scripts[] = 'crafto-lightbox-gallery';
				}

				if ( crafto_disable_module_by_key( 'atropos' ) ) {
					$portfolio_list_scripts[] = 'atropos';
				}

				if ( crafto_disable_module_by_key( 'justified-gallery' ) ) {
					$portfolio_list_scripts[] = 'justified-gallery';
				}

				if ( crafto_disable_module_by_key( 'imagesloaded' ) ) {
					$portfolio_list_scripts[] = 'imagesloaded';
				}

				if ( crafto_disable_module_by_key( 'isotope' ) ) {
					$portfolio_list_scripts[] = 'isotope';
				}

				if ( crafto_disable_module_by_key( 'infinite-scroll' ) ) {
					$portfolio_list_scripts[] = 'infinite-scroll';
				}

				if ( crafto_disable_module_by_key( 'appear' ) ) {
					$portfolio_list_scripts[] = 'appear';
				}

				if ( crafto_disable_module_by_key( 'fitvids' ) ) {
					$portfolio_list_scripts[] = 'jquery.fitvids';
				}
				$portfolio_list_scripts[] = 'crafto-portfolio-widget';
			}
			return $portfolio_list_scripts;
		}
		/**
		 * Retrieve the list of styles the portfolio widget depended on.
		 *
		...
		public function get_style_depends() {
			$portfolio_list_styles = [];

			if ( \Crafto_Addons_Extra_Functions::crafto_editor_load_compressed_assets() ) {
				if ( is_rtl() ) {
					$portfolio_list_styles[] = 'crafto-widgets-rtl';
				} else {
					$portfolio_list_styles[] = 'crafto-widgets';
				}
			} else {
				if ( crafto_disable_module_by_key( 'magnific-popup' ) ) {
					$portfolio_list_styles[] = 'magnific-popup';
				}

				if ( crafto_disable_module_by_key( 'justified-gallery' ) ) {
					$portfolio_list_styles[] = 'justified-gallery';
				}

				if ( crafto_disable_module_by_key( 'atropos' ) ) {
					$portfolio_list_styles[] = 'atropos';
				}

				if ( is_rtl() ) {
					$portfolio_list_styles[] = 'crafto-portfolio-rtl-widget';
				}
				$portfolio_list_styles[] = 'crafto-portfolio-widget';
			}
			return $portfolio_list_styles;
		}
		/**
		...
		public function get_title() {
			return esc_html__( 'Crafto Portfolio List', 'crafto-addons' );
		}
		...
		public function get_custom_help_url() {
			return 'https://crafto.themezaa.com/documentation/portfolio-list/';
		}
		/**
		...
		protected function register_controls() {
			...
			$this->end_controls_section();
			$this->start_controls_section(
				'crafto_section_portfolio_filter_settings',
				[
			...
			$this->add_control(
				...
				[
					'label'        => esc_html__( 'Enable Portfolio Filter', 'crafto-addons' ),
					'type'         => Controls_Manager::SWITCHER,
					'label_on'     => esc_html__( 'Yes', 'crafto-addons' ),
					'label_off'    => esc_html__( 'No', 'crafto-addons' ),
					'return_value' => 'yes',
			...
			$this->add_control(
				'crafto_portfolio_categories_orderby',
				[
					'label'     => esc_html__( 'Order By', 'crafto-addons' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'name',
			...
			$this->add_control(
				'crafto_portfolio_categories_order',
				[
					'label'     => esc_html__( 'Sort By', 'crafto-addons' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'DESC',
			...
			$this->add_control(
				'crafto_portfolio_filter_type_selection',
				[
					'label'     => esc_html__( 'Meta Type', 'crafto-addons' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'portfolio-category',
			...
			$this->add_control(
				...
				[
					...
					'condition'   => [
						'crafto_enable_filter' => 'yes',
						'crafto_portfolio_filter_type_selection' => 'portfolio-category',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'condition'   => [
						'crafto_enable_filter' => 'yes',
						'crafto_portfolio_filter_type_selection' => 'portfolio-tags',
					],
				]
			);
			$this->add_control(
			...
			$this->add_control(
				'crafto_portfolio_heading_enable',
				[
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'condition'   => [
						'crafto_portfolio_heading_enable' => 'yes',
						'crafto_enable_filter'            => 'yes',
					],
				]
			);
			$this->add_control(
				'crafto_portfolio_heading_size',
				[
			...
			$this->end_controls_section();
			$this->start_controls_section(
				'crafto_portfolio_filter_items_style',
				[
					'label'      => esc_html__( 'Filter', 'crafto-addons' ),
					'tab'        => Controls_Manager::TAB_STYLE,
					'show_label' => false,
			...
			$this->add_responsive_control(
				'crafto_section_portfolio_filter_align',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .filter-wrap' => 'display: flex; justify-content: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .filter-wrap' => 'border-radius: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'selectors'  => [
						'{{WRAPPER}} .filter-wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				'crafto_portfolio_filter_margin',
				[
					'label'      => esc_html__( 'Margin', 'crafto-addons' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [
					...
					'selectors'  => [
						'{{WRAPPER}} .filter-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_group_control(
				Group_Control_Box_Shadow::get_type(),
				[
					'name'     => 'crafto_portfolio_filter_box_shadow',
					'selector' => '{{WRAPPER}} .filter-wrap',
				]
			);
			$this->add_control(
			...
			$this->add_group_control(
				Group_Control_Typography::get_type(),
				[
					'name'     => 'crafto_portfolio_filter_items_typography',
					'global'   => [
						'default' => Global_Typography::TYPOGRAPHY_PRIMARY,
					],
					'selector' => '{{WRAPPER}} .grid-filter li span',
				]
			);

			$this->start_controls_tabs( 'crafto_portfolio_filter_items_tabs' );
				$this->start_controls_tab( 'crafto_portfolio_filter_items_normal_tab', [ 'label' => esc_html__( 'Normal', 'crafto-addons' ) ] );
					$this->add_control(
						'crafto_portfolio_filter_items_color',
						[
							'label'     => esc_html__( 'Color', 'crafto-addons' ),
							'type'      => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .grid-filter > li > span' => 'color: {{VALUE}};',
								'{{WRAPPER}} .grid-filter li.active span' => 'border-color: {{VALUE}};',
							],
						]
					);
				$this->end_controls_tab();
				$this->start_controls_tab( 'crafto_portfolio_filter_items_hover_tab', [ 'label' => esc_html__( 'Hover', 'crafto-addons' ) ] );
					$this->add_control(
						'crafto_portfolio_filter_items_hover_color',
						[
							'label'     => esc_html__( 'Color', 'crafto-addons' ),
							'type'      => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .grid-filter > li > span:hover, {{WRAPPER}} .grid-filter > li.active > span' => 'color: {{VALUE}}; border-color: {{VALUE}};',
							],
						]
					);
				$this->end_controls_tab();
			$this->end_controls_tabs();
			$this->add_control(
				'crafto_portfolio_filter_separator_width',
				[
					'label'      => esc_html__( 'Border Thickness', 'crafto-addons' ),
					'type'       => Controls_Manager::SLIDER,
					'size_units' => [
					...
					'selectors'  => [
						'{{WRAPPER}} .grid-filter li span' => 'border-bottom-width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				'crafto_portfolio_filter_items_padding',
				[
					'label'      => esc_html__( 'Padding', 'crafto-addons' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [
					...
					'selectors'  => [
						'{{WRAPPER}} .grid-filter li span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				'crafto_portfolio_filter_items_margin',
				[
					'label'      => esc_html__( 'Margin', 'crafto-addons' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [
					...
					'selectors'  => [
						'{{WRAPPER}} .grid-filter li span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				],
			);
			$this->end_controls_section();
			$this->start_controls_section(
				'crafto_heading_style',
				[
					'label'      => esc_html__( 'Heading', 'crafto-addons' ),
					'tab'        => Controls_Manager::TAB_STYLE,
					'show_label' => false,
			...
			$this->add_group_control(
				Group_Control_Typography::get_type(),
				[
					'name'      => 'crafto_portfolio_heading_typography',
					'selector'  => '{{WRAPPER}} .portfolio-heading',
					'condition' => [
						'crafto_portfolio_heading_enable' => 'yes',
						'crafto_enable_filter'            => 'yes',
					],
			...
			$this->add_control(
				'crafto_portfolio_heading_color',
				[
					'label'     => esc_html__( 'Color', 'crafto-addons' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .portfolio-heading' => 'color: {{VALUE}};',
					],
					'condition' => [
						'crafto_portfolio_heading_enable' => 'yes',
						'crafto_enable_filter'            => 'yes',
			...
			$this->add_responsive_control(
				'crafto_portfolio_heading_margin',
				[
					'label'      => esc_html__( 'Margin', 'crafto-addons' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [
					...
					'selectors'  => [
						'{{WRAPPER}} .portfolio-heading' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->end_controls_section();
		...
		protected function render() {
			...
			$crafto_portfolio_offset              = $this->get_settings( 'crafto_portfolio_offset' );
			...
			if ( ! empty( $crafto_portfolio_offset ) ) {
				$query_args['offset'] = $crafto_portfolio_offset;
			}

			if ( '' !== $categories_to_display_ids[0] ) {
			...
			/* Portfolio Filter */
			if ( 'yes' === $portfolio_enable_filter ) { // phpcs:ignore
				portfolio_filter( $settings, $this );
			}
			/* Portfolio Metro */
					...
					while ( $the_query->have_posts() ) {
						...
						if ( true === $animation_val ) {
							if ( 'yes' === $crafto_enable_animation ) {
								...
								if ( -1 === $portfolio_post_per_page || '-1' === $portfolio_post_per_page ) {
									$published_posts = wp_count_posts()->publish;
								} else {
									$published_posts = $portfolio_post_per_page;
								}
		...
		public function crafto_group_gallery() {
			...
			if ( ! empty( $gallery ) || empty( $crafto_portfolio_gallery ) ) {
				?>
