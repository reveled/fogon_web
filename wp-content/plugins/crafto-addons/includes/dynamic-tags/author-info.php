...
/**
 * Crafto dynamic tag for author info.
 *
 * @package Crafto
 */

// If class `Author_Info` doesn't exists yet.
if ( ! class_exists( 'CraftoAddons\Dynamic_Tags\Author_Info' ) ) {
	/**
	 * Define `Author_Info` class.
	 */
	class Author_Info extends Tag {
		...
		public function get_title() {
			return esc_html__( 'Author Info', 'crafto-addons' );
		}
