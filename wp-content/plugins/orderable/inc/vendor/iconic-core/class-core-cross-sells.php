...
if ( class_exists( 'Orderable_Core_Cross_Sells' ) ) {
	return;
}

/**
 * Orderable_Core_Cross_Sells.
 *
 * @class    Orderable_Core_Cross_Sells
 * @version  1.0.0
 */
class Orderable_Core_Cross_Sells {
	/**
	 * Single instance of the Orderable_Core_License_Uplink object.
	 *
	 * @var Orderable_Core_License_Uplink
	 */
	...
	/**
	 * Creates/returns the single instance Orderable_Core_License_Uplink object.
	 *
	 * @param array $args Arguments.
	 *
	 * @return Orderable_Core_License_Uplink
	 */
	...
	public static function get_api_sidebars() {
		...
		$sidebars  = self::get_remote_data( 'iconic_api_sidebars_orderable', '/wp-json/wp/v2/iconic-api-sidebars?plugin_id=orderable', $base_url );
